...
export class OrderResolverBase {
  ...
  async order(@graphql.Args() args: OrderFindUniqueArgs): Promise<Order | null> {
  ...
  @Public()
  @graphql.Mutation(() => Order)
  async updateOrder(@graphql.Args() args: UpdateOrderArgs): Promise<Order | null> {
    try {
  ...
  @Public()
  @graphql.Mutation(() => Order)
  async deleteOrder(@graphql.Args() args: DeleteOrderArgs): Promise<Order | null> {
    try {
